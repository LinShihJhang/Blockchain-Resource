...
contract UniswapV2PracticeTest is Test {
    ...
    function test_taker_swapExactETHForTokens() public {
        ...
        UNISWAP_V2_ROUTER.swapExactETHForTokens{value: 1 ether}(0, path, taker, block.timestamp + 1000);
    ...
    function test_taker_swapExactTokensForETH() public {
        ...
        UNISWAP_V2_ROUTER.swapExactTokensForETH(100*10**testUSDC.decimals(), 0, path, taker, block.timestamp + 1000);
    ...
    function test_maker_removeLiquidityETH() public {
        ...
        WETHTestUSDCPair.approve(address(UNISWAP_V2_ROUTER), 10e15);
